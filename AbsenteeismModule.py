...
class absenteeism_model():
    ...
    def load_and_clean_data(self, data_file):
        ...
        #to preserve the code we've created in the previous section, we will add a new column with 'NaN' strings
        df['Absenteeism Time in Hours'] = 'NaN'
        
        #create a seperate dataframe, containing dummy values for all variable reasons
    ...
    #add the columns with these values at the end of new data
